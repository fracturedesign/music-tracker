...
const THEMES = {
  ...
  sage:  { name:"Sage",         emoji:"🌿", dark:false, bg:"#f0f4f1", surf:"#ffffff", surf2:"#e3ece5", line:"rgba(0,0,0,0.07)", lineS:"rgba(0,0,0,0.12)", text:"#1a3325", muted:"#4d7060", faint:"#6b8f7a", dim:"#9ab5a3", indigo:"#2f7a4e", deep:"#1e5c37", green:"#2f7a4e", greenS:"#52a870", flame:"#c0622a", accentGrad:"linear-gradient(135deg,#4a9b68,#2f7a4e)", accentGlow:"rgba(47,122,78,0.22)", accentAlpha:"rgba(47,122,78,0.1)", accentAlpha2:"rgba(47,122,78,0.07)", accentBorder:"rgba(47,122,78,0.3)", todayBg:"linear-gradient(160deg,#e6f2eb,#f0f9f3)", timerBg:"linear-gradient(160deg,#e2efe7,#edf7f0)", loggedBg:"linear-gradient(160deg,#e6f2eb,#f0f9f3)", loggedBorder:"rgba(47,122,78,0.3)", heat:["#d8e9dc","#a8d4b4","#6ab88a","#2f7a4e","#1e5c37"] },
};
